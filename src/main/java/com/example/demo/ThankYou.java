...
@WebServlet(description = "ThankYouServlet", value = { "/thankyou" })
public class ThankYou extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String output = this.ThankYouPage(customerName, gender, category, message);
    ...
    private String ThankYouPage(String customerName, String gender, String category, String message) {
